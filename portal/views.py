        ...
        if request.method == 'POST':
            ...
            for users in authentication:
                if (users.password == password):
                    ...
                    #train = pd.read_csv('/Data/E-Kisan-Pasckathon-master/kisan_portal/portal/train.csv')
                    #csv = request.FILES['train.csv']
                    train = pd.read_csv('/Users/KESAV/kisan_portal/portal/train.csv')
