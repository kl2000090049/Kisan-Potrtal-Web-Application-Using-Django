...
def crop_yield(X, district):
    ...
    plt.savefig('/Users/KESAV/kisan_portal/portal/static/plant_predict/images/CvsY.png')
    plt.clf()
    ...
    plt.savefig('/Users/KESAV/kisan_portal/portal/static/water_predict/images/CvsW.png')
    plt.clf()
